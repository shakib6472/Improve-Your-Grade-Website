...
function edubin_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
            ...
            'slug'      => 'edubin-core',
			'source'    => EDUBIN_DIR . '/admin/tgm/plugins/edubin-core.zip',
            'required'  => true,
            'version'   => '9.2.8',
		),	
        array(
        ...
        // ),       
        array(
            'name'     => esc_html__('MasterStudy LMS', 'edubin'),
            'slug'     => 'masterstudy-lms-learning-management-system',
            'required' => false,
        ), 
        array(
            'name'     => esc_html__('WP Events Manager', 'edubin'),
        ...
        array(
            'name'      => esc_html__('Video Conferencing with Zoom','edubin'),
