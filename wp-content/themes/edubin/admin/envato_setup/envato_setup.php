...
if ( ! class_exists( 'Envato_Theme_Setup_Wizard' ) ) {
    ...
    class Envato_Theme_Setup_Wizard {
        ...
        public function get_logo_image() {
            $image_url = get_theme_mod( 'logo_header_image', EDUBIN_URI . 'assets/images/logo.png' );
        ...
        public function init_globals() {
            ...
            $this->plugin_url  = trailingslashit( EDUBIN_URI . $relative_url );
        }
        ...
        public function setup_wizard_header() {
            ...
            // avoid theme check issues.
                ...
                <?php //do_action( 'admin_print_styles' ); ?>
                 ...
                 <!-- Fix the error issue for heck issues-->
                <link rel='stylesheet' id='custom-admin-styles' href='<?php echo esc_url( admin_url('load-styles.php?c=1&dir=ltr&load%5Bchunk_0%5D=dashicons,admin-bar,common,forms,admin-menu,dashboard,list-tables,edit,revisions,media,themes,about,nav-menus,wp-pointer,widgets&load%5Bchunk_1%5D=,site-icon,l10n,buttons,install,media-views&ver=6.6.1') ); ?>' type="text/css" media='all' />
                <link rel='stylesheet' id='envato-setup-css' href='<?php echo esc_url(get_stylesheet_directory_uri()). '/admin/envato_setup/css/envato-setup.css' ?>' media='all' />
                <!-- End fix the error issue for heck issues-->
        ...
        public function envato_setup_introduction() {
            ...
            if ( false && isset( $_REQUEST['debug'] ) ) {
                ...
                ?>
                <h1><?php printf( __( 'Welcome to the %s  Setup Wizard.','edubin' ), wp_get_theme() ); ?></h1>
                ...
                <p class="envato-setup-actions step">
                    ...
                    <h1><?php printf( __( 'Welcome to the %s  Setup Wizard.','edubin' ), wp_get_theme() ); ?></h1>
                        ...
                        echo '<p>';
                        printf(
                            __( 'Simply follow these steps to install of Edubin theme by Pixelcurve. If you need any help, please do not hesitate to contact our <a target="_blank" class="" href="%s">support desk</a>.', 'edubin' ),
                            esc_url( 'https://thepixelcurve.com/support/' )
                        );
                        echo '</p>';
                        ...
                        echo '<div style="margin-bottom: -25px; display: flex; align-items: center;">';
                        echo '<a href="' . esc_url($anchor_url) . '" target="_blank">';
                        echo '<img src="' . esc_url($image_url) . '" alt="paly tutorial" style="max-width: 100px; margin-right: 10px; height: auto; position: relative; bottom: 6px;" />';
                        echo '</a>';
                        echo '<p>';
                        echo '<a href="' . esc_url($anchor_url) . '" target="_blank" style="text-decoration: none; color: #0073aa;">' . esc_html($text) . '</a>';
                        echo ' to watch the video tutorial on installing the Edubin theme.</p>';
            ...
            <?php if ( function_exists( 'envato_market' ) ) { ?>
                <form method="post">
                    ...
                    if ( count( $my_items ) ) {
                        ...
                        <p><?php esc_html_e( "When an update becomes available it will show in the Dashboard with an option to install.",'edubin' ); ?> <?php printf( __( 'To get it you have to configure the Envato Market Plugin.','edubin') ); ?> 
    ...
    <p>
        ...
        public function envato_setup_ready() {
            ...
            <p class="greendata"><?php esc_html_e( 'Congratulations! The theme and the required plugins have been activated. Click the "Activate Your License" button for demo import.','edubin' ); ?></p>
                ...
                if ( !$option || empty($option['oauth']) || empty( $option['oauth'][ $this->envato_username ] ) || empty($envato_items) || empty($envato_items['items']) || !envato_market()->items()->themes( 'purchased' )) {
                    ...
                    if ( ! $dissmissed_time || $dissmissed_time < strtotime('-7 days') ) {
                        ...
                        <div class="notice notice-warning notice-dtbwp-themeupdates is-dismissible">
                            ...
                            <p>
                                <?php printf( __( 'Configure the Envato Market Plugin to receive theme update notifications.','edubin') ); ?> 
