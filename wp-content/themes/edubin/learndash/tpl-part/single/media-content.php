...
//if ( !$ld_intro_video_position == 'none' ) {

if ($edubin_ld_video && $ld_intro_video_position == 'intro_video_content') : 
...
elseif( has_post_thumbnail() && $ld_intro_video_position == 'intro_video_content') : 
