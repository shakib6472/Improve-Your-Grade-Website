...
echo '<div class="edubin-course layout__' . esc_attr( $args['style'] ) . ' col__3">';
    echo '<div class="course__container">';
        ...
        echo '<div class="course__content">';
            ...
            if ( function_exists( 'ldcr_course_rating_stars' ) && $args['show_review']) :
            ...
            if ( $args['show_author_img'] || $args['show_author_name'] || $args['show_topic']|| $args['show_lessons'] || $args['show_quiz'] ): 
            echo '<div class="course__border"></div>';
                ...
                echo '<div class="course__content--meta">';
                    ...
                    if ( $args['show_topic']|| $args['show_lessons']) {
