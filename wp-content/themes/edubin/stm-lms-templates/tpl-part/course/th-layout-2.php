    ...
    echo '<div class="course__container">';
        ...
        echo '<div class="course__content">';
           ...
           if ( Edubin::setting( 'ms_excerpt_show' ) ) :
            ...
            if ( Edubin::setting( 'ms_instructor_img_on_off' ) || Edubin::setting( 'ms_instructor_name_on_off' ) || Edubin::setting( 'ms_enrolled_show' ) || Edubin::setting( 'ms_lesson_show' ) || Edubin::setting( 'ms_quiz_show' )): 
