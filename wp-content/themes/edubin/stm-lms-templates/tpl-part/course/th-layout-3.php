    ...
    echo '<div class="course__container">';
        ...
        if ( Edubin::setting( 'ms_archive_media_show' ) ) {
            echo '<div class="course__media">';
                ...
                echo '<div class="course__meta-top">';
                   ...
                   $skill = \STM_LMS_Helpers::parse_meta_field( get_the_ID() );

                   if ( !empty($skill['level']) && Edubin::setting( 'ms_level_show' ) ) {
                        echo '<div class="course__levels">';
                           echo esc_html($skill['level']);
                        echo '</div>';
                   }
        ...
        echo '<div class="course__content">';
            ...
            echo '<div class="course__content--meta">';
                ...
                if ( Edubin::setting( 'ms_review_show' ) || Edubin::setting( 'ms_enrolled_show' ) || Edubin::setting( 'ms_lesson_show' ) || Edubin::setting( 'ms_quiz_show' )  ) {
