            ...
            <div class="row tpc_g_30 edubin-latest-news layout-<?php echo esc_attr($settings['layout_style']);?>">
                ...
                if($query->have_posts()): 
                    while($query->have_posts()): 
                        ...
                        <div class="<?php if( $settings['layout_style'] == '6') : echo 'edubin-no-gutters'; endif; ?> edubin-col-12 edubin-col-sm-6 edubin-col-md-6 edubin-col-lg-<?php echo esc_attr($clm_layout_2); ?> <?php if( $settings['layout_style'] == '1' || $settings['layout_style'] == '5' || $settings['layout_style'] == '6') : echo $clm_layout_2; else : echo $column_layout_left; endif; ?> ">
                            <div class="single-news" <?php echo esc_attr($animation_attribute)?>>
                                <?php if (has_post_thumbnail()): ?>
                                    <div class="news-thum">
                                        <a href="<?php the_permalink(); ?>">
                                            <?php the_post_thumbnail( $settings['image_size_size'] );?>
                                        </a>
                                        <?php if ( $settings['post_label'] === 'yes' ) : ?>
                                            <div class="news-label">
                                                <span> <?php echo esc_html( $settings['label_text'] )?>  </span>
                                            </div>
                                        <?php endif;?>
                                    </div>
                                <?php else: ?>
                                    ...
                                    <div class="news-cont">
                                        ...
                                        <ul>
                                            <?php if( !empty($settings['show_date']) ): ?>
                                                <li><a href="<?php echo esc_url( get_day_link( $archive_year, $archive_month, $archive_day) ); ?>"><i class="flaticon-calendar"></i><?php the_time(esc_html__('d F Y','edubin-core'));?> </a></li>
                                            <?php endif; ?>
                                            <?php if( !empty($settings['show_author']) ): ?>
                                                <li><i class="flaticon-user"></i><a href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ); ?>"> <?php echo esc_html( get_the_author() ); ?></a></li>
                                            <?php endif; ?>
                                        </ul>
                        ...
                        <nav class="edubin-pagination-wrapper tpc-custom-pagination" role="navigation" aria-label="Posts">
        ...
        <?php elseif( $settings['layout_style'] == '2' || $settings['layout_style'] == '3'  || $settings['layout_style'] == '4' ) : ?>
            <div class="row tpc_g_30 edubin-latest-news">
                <?php 
                    ...
                    ?>
                <div class="edubin-col-lg-<?php echo $column_layout_left; ?> ">
                    <?php 
                    $query = new \WP_Query($single_args);
                    if($query->have_posts()): 
                        while($query->have_posts()): 
                            ...
                            <div class="single-news news-big" <?php echo esc_attr($animation_attribute)?>>
                                <?php if (has_post_thumbnail()): ?>
                                            ...
                                            <div class="edubin-news-meta">
                                                ...
                                                ?>
                                                    ...
                                                    <ul>
                                                        ...
                                                        <?php if( !empty($settings['show_author']) ): ?>
                                                            <li><a href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ); ?>"> <span><i class="flaticon-user"></i></span> <?php echo esc_html( get_the_author() ); ?></a></li>
                                                        <?php endif; ?>
                                                    </ul>
                        ...
                        <?php 
                            ...
                            ?>
                        <div class="edubin-col-lg-<?php echo $column_layout_right; ?>">
                            <?php 
                            ...
                            if($query->have_posts()): 
                                while($query->have_posts()): 
                                    ...
                                    <div class="single-news news-list" <?php echo esc_attr($animation_attribute)?>>
