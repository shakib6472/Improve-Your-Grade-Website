        ...
        echo '<div class="thumbnail">';
            ...
            if ( $start_time ) :
                echo '<span class="edubin-event-date">';
                    echo '<span>'.esc_html( wp_date('d', $start_time ) ).'</span>';
                    echo '<span>'.esc_html( wp_date('M', $start_time ) ).'</span>';
                echo '</span>';
    ...
    echo '<div class="content">';
        ...
        if ( $location ) :
            ...
            echo '<div class="edubin-event-meta">';
                echo '<span class="event-location"><i class="flaticon-location"></i>'. esc_html( $location ).'</span>';
            echo '</div>';
