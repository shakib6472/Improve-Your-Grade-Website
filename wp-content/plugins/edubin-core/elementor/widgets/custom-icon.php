...
class Edubin_Elementor_Widget_Custom_Icon extends Widget_Base {
    ...
    {
        return 'edubin-elementor-icon eicon-dot-circle-o';
    }
    ...
    protected function register_controls() {
        ...
        //          ],
        //          'center' => [
        //              'title' => esc_html__( 'Middle', 'edubin-core' ),
        //              'icon' => 'eicon-v-align-middle',
        //          ],
        //          'end' => [
        //              'title' => esc_html__( 'Bottom', 'edubin-core' ),
        ...
        //      'toggle' => false,
        //      'selectors' => [
        //          '{{WRAPPER}} ..elementor-widget-edubin-custom-icon.elementor-vertical-align-middle .elementor-icon-box-wrapper' => 'align-items: {{VALUE}};',
        //      ],
        //      'condition' => [
        //          'position!' => 'top',
        //      ],
        ...
        $this->add_responsive_control(
            'icon_top_space',
            [
                'label' => esc_html__( 'Image Top Spacing', 'edubin-core' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => -300,
        ...
        $this->add_responsive_control(
            'icon_line_height',
            [
                'label' => esc_html__( 'Line Height', 'edubin-core' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 0,
                ...
                'selectors' => [
                    '{{WRAPPER}} .elementor-icon-box-icon .elementor-icon' => 'line-height: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            'icon_shape',
            [
                'label' => esc_html__( 'Add Icon Shape?', 'edubin-core' ),
            ...
            <div class="elementor-icon-box-icon">
                ...
                <?php 
                    if ($settings['selected_image']) : ?>
                        ...
                        <?php echo ($settings['icon_shape']) ? ('<div class="icon-shape-wrap"></div>') : ('') ?>
