...
class Courses extends \EdubinCore\Widgets\Courses_LI_Options {

    public function get_name() {
        return 'edubin-lif-courses';
    }

    public function get_title() {
        return __( 'Courses ( LifterLMS )', 'edubin-core' );
    }

    public function get_keywords() {
        return [ 'edubin', 'courses', 'lms', 'lifterlms', 'archive', 'loop', 'grid', 'slider', 'carousel', 'filter' ];
    }

    protected $post_type         = 'course';
    protected $category_taxonomy = 'course_cat';
...
// ===
    ...
    protected function render() {
        ...
        $this->add_render_attribute( 'container', 'class', 'tpc-lifter-archive-courses' );
