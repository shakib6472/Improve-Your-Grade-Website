...
class Edubin_Elementor_Video_PopUp extends Widget_Base {
    ...
    public function get_icon() {
        return 'edubin-elementor-icon eicon-play';
    }
    ...
    protected function render( $instance = [] ) {
       ...
       $settings = $this->get_settings_for_display();
        ...
        <?php if ($settings['video_style'] == '1'): ?>
            ...
            <div class="video">
                <a class="<?php echo $id; ?>bla-<?php if ($settings['yt_autoplay'] == 'yes'): echo '1'; else: echo '2'; endif;?>" href="<?php if ($settings['video_type'] == 'youtube'): ?><?php echo $settings['video_link']; ?><?php else: echo $settings['vimeo_link']; endif;?>"><i class="flaticon-play-button"></i></a>
            </div>

        <?php elseif ($settings['video_style'] == '2'): ?>

          <a href="<?php if ($settings['video_type'] == 'youtube'): ?><?php echo $settings['video_link']; ?><?php else: echo $settings['vimeo_link']; endif;?>" class="icon-video play-icon-text <?php echo $id; ?>bla-<?php if ($settings['yt_autoplay'] == 'yes'): echo '1'; else: echo '2'; endif;?>"><i class="flaticon-play-button" aria-hidden="true">&nbsp;</i> <?php echo $settings['popup_text']; ?></a>

        <?php elseif ($settings['video_style'] == '3'): ?>

          <a class="play-btn <?php echo $id; ?>bla-<?php if ($settings['yt_autoplay'] == 'yes'): echo '1'; else: echo '2'; endif;?>" href="<?php if ($settings['video_type'] == 'youtube'): ?><?php echo $settings['video_link']; ?><?php else: echo $settings['vimeo_link']; endif;?>"></a>
        ...
        <?php elseif ($settings['video_style'] == 'edubin-video-popup' || $settings['video_style'] == 'edubin-video-popup-left' || $settings['video_style'] == 'edubin-video-popup-round' && $settings['video_type'] == 'youtube'): ?>
               ...
               <div class="<?php echo $settings['video_style'] ?>">
                  ...
                  <a href="<?php echo $settings['video_link']; ?>" class="icon-video <?php echo $id; ?>bla-<?php if ($settings['yt_autoplay'] == 'yes'): echo '1'; else: echo '2'; endif;?>"><span><i class="flaticon-play-button"></i></span></a>
               </div>
       ...
       <?php elseif ($settings['video_style'] == 'edubin-video-popup' || $settings['video_style'] == 'edubin-video-popup-left' || $settings['video_style'] == 'edubin-video-popup-round' && $settings['video_type'] == 'vimeo'): ?>
               ...
               <div class="<?php echo $settings['video_style'] ?>">
                  <img src="<?php echo $settings['image_overlay']['url']; ?>" alt="Video Overlay Image">
                  <a href="<?php echo $settings['vimeo_link']; ?>" class="icon-video <?php echo $id; ?>bla-<?php if ($settings['yt_autoplay'] == 'yes'): echo '1'; else: echo '2'; endif;?>"><span><i class="flaticon-play-button"></i></span></a>
               </div>
