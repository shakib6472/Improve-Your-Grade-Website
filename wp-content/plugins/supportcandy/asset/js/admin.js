...
function wpsc_get_agent_dashboard(is_humbargar = false) {
	...
	window.history.replaceState( {}, null, 'admin.php?page=wpsc-tickets&section=dashboard' );
	jQuery( '.wpsc-body' ).html( supportcandy.loader_html );
...
function wpsc_set_ms_term_and_conditions(el) {
	...
	var dataform = new FormData( form );
	jQuery( '.wpsc-modal-footer button' ).attr( 'disabled', true );
	var is_tinymce_ct = (typeof tinyMCE != "undefined") && tinyMCE.get('tandc-text') && ! tinyMCE.get('tandc-text').isHidden();
	...
	var is_tinymce_reg = (typeof tinyMCE != "undefined") && tinyMCE.get('tandc-text-reg-user') && ! tinyMCE.get('tandc-text-reg-user').isHidden();
...
function wpsc_set_ms_gdpr(el) {
	...
	jQuery( '.wpsc-modal-footer button' ).attr( 'disabled', true );
	jQuery( '.wpsc-modal-footer button' ).attr( 'disabled', true );
	var is_tinymce_ct = (typeof tinyMCE != "undefined") && tinyMCE.get('gdpr-text') && ! tinyMCE.get('gdpr-text').isHidden();
	...
	var is_tinymce_reg = (typeof tinyMCE != "undefined") && tinyMCE.get('gdpr-text-reg-user') && ! tinyMCE.get('gdpr-text-reg-user').isHidden();
...
function wpsc_get_dashboard_settings(is_humbargar = false) {
	...
	jQuery( '.wpsc-setting-nav, .wpsc-humbargar-menu-item' ).removeClass( 'active' );
	jQuery( '.wpsc-setting-nav.dashboard-settings, .wpsc-humbargar-menu-item.dashboard-settings' ).addClass( 'active' );
	jQuery( '.wpsc-humbargar-title' ).html( supportcandy.humbargar_titles.tickettags );
...
function wpsc_set_dashboard_card_load_order(slugs, nonce) {
	...
	jQuery( '.wpsc-setting-section-body' ).html( supportcandy.loader_html );
	var data = { action: 'wpsc_set_dashboard_card_load_order', slugs, _ajax_nonce: nonce };
	jQuery.post(
		supportcandy.ajax_url,
		data,
		function (res) {
...
function wpsc_reset_dashboard_general_settings(el, nonce) {
	...
	jQuery( '.wpsc-modal-footer button' ).attr( 'disabled', true );
	jQuery( el ).text( supportcandy.translations.please_wait );
	var data = { action: 'wpsc_reset_dashboard_general_settings', _ajax_nonce: nonce };
	jQuery.post(
		supportcandy.ajax_url,
		data,
		function (response) {
...
function wpsc_delete_dashboard_widget(slug, nonce) {
	...
	jQuery( '.wpsc-setting-section-body' ).html( supportcandy.loader_html );
	var data = { action: 'wpsc_delete_dashboard_widget', slug, _ajax_nonce: nonce };
	jQuery.post(
		supportcandy.ajax_url,
		data,
		function (response) {
...
function wpsc_set_dashboard_widget_load_order(slugs, nonce) {
	...
	jQuery( '.wpsc-setting-section-body' ).html( supportcandy.loader_html );
	var data = { action: 'wpsc_set_dashboard_widget_load_order', slugs, _ajax_nonce: nonce };
	jQuery.post(
		supportcandy.ajax_url,
		data,
		function (res) {
...
function wpsc_get_edit_dashboard_card_widget( type, slug, nonce ) {
	...
	wpsc_show_modal();
	var data = { action: 'wpsc_get_edit_dashboard_card_widget', type, slug, _ajax_nonce: nonce };
	jQuery.post(
		supportcandy.ajax_url,
		data,
		function (response) {
...
function wpsc_get_ap_dashboard() {
  ...
  jQuery(".wpsc-setting-tab-container button").removeClass("active");
  jQuery(".wpsc-setting-tab-container button." + supportcandy.current_tabs).addClass("active");
...
function wpsc_view_customer_detailed_info(customer_id, nonce) {
	...
	jQuery( '.wpsc-setting-section-body' ).html( supportcandy.loader_html );
	var data = { action: 'wpsc_view_customer_detailed_info', customer_id, _ajax_nonce: nonce };
	jQuery.post(
		supportcandy.ajax_url,
		data,
		function (res) {
