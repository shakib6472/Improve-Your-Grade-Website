...
if ( ! class_exists( 'WPSC_DF_Source' ) ) :

	final class WPSC_DF_Source {
		...
		public static function get_ticket_field_val( $cf, $ticket, $module = '' ) {
			...
			return apply_filters( 'wpsc_ticket_field_val_source', $value, $cf, $ticket, $module );
		}
