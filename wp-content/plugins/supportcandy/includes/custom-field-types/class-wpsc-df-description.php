					...
					<div class="actions">
						<div class="wpsc-editor-actions">
							...
							if ( WPSC_Text_Editor::is_allow_attachments() ) {
								?>
								<span class="wpsc-link wpsc-ct-attach" onclick="wpsc_trigger_desc_attachments('<?php echo esc_attr( $unique_id ); ?>');"><?php esc_attr_e( 'Attach Files', 'supportcandy' ); ?></span>
								<?php
							}

							if ( $current_user->is_agent ) {
								?>
								<span class="wpsc-link wpsc-ct-macro" onclick="wpsc_get_macros()"><?php esc_attr_e( 'Insert Macro', 'supportcandy' ); ?></span>
								<?php
							}
